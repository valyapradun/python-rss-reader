...
## Running Unit tests
All Unit tests are in file _src/reader/rss_reader_test.py_. To run them:
```
> python src/reader/rss_reader_test.py

```
As a result:
```
..Starting test test_check_date_correct_value...
Ending test test_check_date_correct_value...
.Starting test test_check_date_incorrect_value...
Ending test test_check_date_incorrect_value...
.Starting test test_check_limit_correct_value...
Ending test test_check_limit_correct_value...
.Starting test test_check_limit_incorrect_value...
Ending test test_check_limit_incorrect_value...
.Starting test test_pass_to_html...
Ending test test_pass_to_html...
.Starting test test_pass_to_pdf...
Ending test test_pass_to_pdf...
.Starting test test_read_cashed_news...
Ending test test_read_cashed_news...
.
----------------------------------------------------------------------
Ran 9 tests in 6.145s
